...
public abstract class BaseAsynTask<Params, Progress, Result> extends
	...
	public static class TaskResult<Result> {
		...
		public final BaseAsynTask<?, ?, Result> Task;

		public final int Status;

		public TaskResult(BaseAsynTask<?, ?, Result> task, Result value,
				int status) {
			this.Value = value;
			this.Task = task;
			this.Status = status;
