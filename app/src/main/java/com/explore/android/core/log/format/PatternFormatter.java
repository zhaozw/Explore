...
package com.explore.android.core.log.format;
...
import com.explore.android.core.log.format.command.CategoryFormatCommand;
import com.explore.android.core.log.format.command.ClientIdFormatCommand;
import com.explore.android.core.log.format.command.DateFormatCommand;
import com.explore.android.core.log.format.command.FormatCommandInterface;
import com.explore.android.core.log.format.command.MessageFormatCommand;
import com.explore.android.core.log.format.command.NoFormatCommand;
import com.explore.android.core.log.format.command.PriorityFormatCommand;
import com.explore.android.core.log.format.command.ThreadFormatCommand;
import com.explore.android.core.log.format.command.ThrowableFormatCommand;
import com.explore.android.core.log.format.command.TimeFormatCommand;
...
public class PatternFormatter implements Formatter {
	...
	/**
	 * @see com.google.code.microlog4android.format.Formatter#setProperty(String,
	 *      String)
	 */
