 ...
 * 
 */
package com.explore.android.core.log.config;
...
import com.explore.android.core.log.appender.FileAppender;
import com.explore.android.core.log.format.Formatter;
...
/**
 * The {@link com.explore.android.core.log.config.PropertyConfigurator} is used for configuration via a properties
...
public class PropertyConfigurator {
	...
	public static final String[] APPENDER_CLASS_NAMES = { "com.explore.android.core.log.appender.LogCatAppender",
			"com.explore.android.core.log.appender.FileAppender" };

	public static final String[] FORMATTER_ALIASES = { "SimpleFormatter", "PatternFormatter" };

	public static final String[] FORMATTER_CLASS_NAMES = { "com.explore.android.core.log.format.SimpleFormatter",
			"com.explore.android.core.log.format.PatternFormatter" };
	 ...
	 * 
	 * @param context
	 *            the {@link android.content.Context} to get the configurator for.
	...
	public void configure(String filename) {
		...
		try {
			...
			Log.e(TAG, "Failed to open the microlog properties file. Hint: the file should be in the /assets directory " + filename + " " + e);
		}
	}
